        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $barang->barang_kode }}" type="text" name="barang_kode" id="barang_kode" class="form-control" required maxlength="10">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        dataBarang.ajax.reload(); // Pastikan ini sesuai dengan nama datatable Anda
                    } else {
                        $('.error-text').text('');
