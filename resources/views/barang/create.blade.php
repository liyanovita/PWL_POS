    ...
    <div class="card-body">
        <form method="POST" action="{{ url('barang') }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" id="barang_kode" name="barang_kode" value="{{ old('barang_kode') }}" required maxlength="10">
                    @error('barang_kode')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="number" class="form-control" id="harga_beli" name="harga_beli" value="{{ old('harga_beli') }}" required min="0">
                    @error('harga_beli')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="number" class="form-control" id="harga_jual" name="harga_jual" value="{{ old('harga_jual') }}" required min="0">
                    @error('harga_jual')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
