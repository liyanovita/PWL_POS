        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="{{ $supplier->supplier_kode }}" type="text" name="supplier_kode" id="supplier_kode" class="form-control" required maxlength="10">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        dataSupplier.ajax.reload(); // Reloading the DataTable for suppliers
                    } else {
                        $('.error-text').text('');
