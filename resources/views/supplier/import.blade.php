    ...
    $(document).ready(function() {
        $("#form-import").validate({
            ...
            submitHandler: function(form) {
                var formData = new FormData(form); // Mengubah form menjadi FormData untuk meng-handle file

                $.ajax({
                    url: form.action,
                    type: form.method,
                    data: formData, // Data yang dikirim berupa FormData
                    processData: false, // Mengatur processData ke false untuk meng-handle file
                    contentType: false,
